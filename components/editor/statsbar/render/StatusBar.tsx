        ...
        <div className="status-bar">
            ...
            <div className="status">
                {small
                    ...
                    : <span className="status-label emph">Execution Time</span>
                }
                <span className="status-value" id="status-time">0ms</span>
            </div>
            <div className="status">
                {small
                    ? <span className="status-label icon emph">layers</span>
                    : <span className="status-label emph">Render Time</span>
                }
