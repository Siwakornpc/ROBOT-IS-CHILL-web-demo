...
export const DEFAULT_PALETTE: SwatchItem[] = [
    ...
    { color: "#737373", value: [0, 1], label: "grey,gray" },
    { color: "#c3c3c3", value: [0, 2], label: "silver" },
    { color: "#ffffff", value: [0, 3], label: "white" },
    { color: "#080808", value: [0, 4], label: "black" },
    { color: "#15181f", value: [1, 0] },
    { color: "#293141", value: [1, 1] },
    { color: "#3e7688", value: [1, 2], label: "teal" },
    { color: "#5f9dd1", value: [1, 3] },
    { color: "#83c8e5", value: [1, 4], label: "cyan" },
    { color: "#421910", value: [2, 0] },
    { color: "#82261c", value: [2, 1], label: "maroon" },
    { color: "#e5533b", value: [2, 2], label: "red" },
    { color: "#e49950", value: [2, 3], label: "orange" },
    { color: "#ede285", value: [2, 4], label: "yellow" },
    { color: "#603981", value: [3, 0] },
    { color: "#8e5e9c", value: [3, 1], label: "purple" },
    ...
    { color: "#90673e", value: [6, 1], label: "brown" },
    { color: "#c29e46", value: [6, 2], label: "gold" },
